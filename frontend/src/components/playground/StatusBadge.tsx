const statusClasses: Record<string, string> = {
  ...
  targets: "border-sky-400/30 bg-sky-400/12 text-sky-200",
  ...
  notice: "border-amber-400/30 bg-amber-400/12 text-amber-200",
  ...
  weekly: "border-violet-400/30 bg-violet-400/12 text-violet-200",
